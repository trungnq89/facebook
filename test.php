...
list($width, $height, $type, $attr) = getimagesize("http://web.com/vamp/williamhill.png");
    ...
    <body>
        <div id="content">
            ...
            <div id="background" class="background"> 
				<img id="obj_0" width="<?php echo $width;?>" height="<?php echo $height;?>" style="margin:0px auto;"  src="http://web.com/vamp/williamhill.png"></img> 
            </div>
			<div>
            <div id="tools">
            </div>
        ...
        <script>
            $(document).ready(function(id) {
				...
				var data = {
                    "images": [
                        {"id" : "obj_0" ,"src" : "http://web.com/vamp/williamhill.png"	,"width" : "<?php echo $width; ?>", "height" : "<?php echo $height; ?>"}
                    ]
                };
