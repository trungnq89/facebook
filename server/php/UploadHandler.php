...
class UploadHandler {
    ...
    protected $error_messages = array(
        1 => 'Dung lượng file upload vượt quá dung lượng upload cho phép của máy chủ',
        2 => 'Dung lượng file upload vượt quá dung lượng cho phép',
        3 => 'The uploaded file was only partially uploaded',
        4 => 'File upload thất bại',
        6 => 'Không tồn tại thư mục temp trên máy chủ',
        7 => 'Không thể lưu file upload trên máy chủ',
        8 => 'A PHP extension stopped the file upload',
        'post_max_size' => 'The uploaded file exceeds the post_max_size directive in php.ini',
        'max_file_size' => 'File quá lớn, không thể upload',
        'min_file_size' => 'Khích thước file quá nhỏ',
        'accept_file_types' => 'Định dạng file không cho phép',
        'max_number_of_files' => 'Số lượng file upload quá lớn',
...
// Get User ID
        ...
        if ($user) {
            ...
            $user_exit = $db->checkRecodeExist("id", "fb_user", " fb_id = " . $user_profile["id"], true, true, $dataInsert);
            if ($user_exit)
                $userDir = "user" . $user_exit . "/";
        }
        $this->options = array(
            'script_url' => $this->get_full_url() . '/',
            'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']) . '/files/' . $userDir,
            'upload_url' => $this->get_full_url() . '/files/' . $userDir,
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
